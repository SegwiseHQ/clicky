...
class SplashScreen:
    ...
    def create_splash_window(self):
        ...
        # Load splash image
        splash_image_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "assets", "splash.png")
        ...
        try:
            if os.path.exists(splash_image_path):
                ...
                with texture_registry(show=False):
                    add_static_texture(width=width, height=height, default_value=data, tag="splash_image_texture")
        ...
        with window(
            ...
            with group(horizontal=False):
                ...
                with group(horizontal=True):
                    ...
                    add_text(f"{icon_manager.get('database')} ClickHouse Client", tag="splash_title")
    ...
    def _start_loading_animation(self):
        ...
        self.should_animate = True
        self.loading_thread = threading.Thread(target=self._animate_loading_dots, daemon=True)
