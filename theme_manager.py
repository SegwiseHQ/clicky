...
class ThemeManager:
    ...
    def _create_global_theme(self):
        ...
        with theme() as self.themes["global"], theme_component(mvAll):
            # Window background
    ...
    def _create_button_themes(self):
        ...
        with theme() as self.themes["button_primary"]:
            with theme_component(mvButton):
                ...
                add_theme_color(
                    mvThemeCol_ButtonHovered, (79, 82, 198)
                )  # Indigo-600 on hover
                add_theme_color(
                    mvThemeCol_ButtonActive, (67, 70, 178)
        ...
        with theme() as self.themes["button_secondary"]:
            with theme_component(mvButton):
                ...
                add_theme_color(
                    mvThemeCol_ButtonHovered, (55, 55, 70)
                )  # Slightly lighter on hover
                add_theme_color(
                    mvThemeCol_ButtonActive, (65, 65, 82)
                )  # Even lighter on click
                add_theme_color(mvThemeCol_Text, (255, 255, 255))
                add_theme_style(mvStyleVar_FrameRounding, 8)
                add_theme_style(mvStyleVar_FramePadding, 10, 6)
    ...
    def _create_table_themes(self):
        ...
        with theme() as self.themes["table_enhanced"], theme_component(mvTable):
        ...
        with theme() as self.themes["table_button"], theme_component(mvButton):
    ...
    def _create_window_themes(self):
        ...
        with theme() as self.themes["status_window"]:
            with theme_component(mvChildWindow):
                ...
                add_theme_color(
                    mvThemeCol_Border, (55, 55, 70)
                )  # Slightly visible accent
                add_theme_style(
    ...
    def _create_text_themes(self):
        ...
        # Header text theme
        with theme() as self.themes["header_text"], theme_component(mvText):
            add_theme_color(mvThemeCol_Text, COLOR_EXPLORER_TITLE)

        # Success text theme
        with theme() as self.themes["success_text"], theme_component(mvText):
