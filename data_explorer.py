...
class DataExplorer:
    ...
    def refresh_data(self, status_callback=None):
        ...
        try:
            ...
            # Create data table with borders and headers
            table_tag = "explorer_data_table"
            add_table(tag=table_tag, parent="explorer_data_window", 
                     borders_innerH=True, borders_innerV=True, borders_outerH=True, borders_outerV=True,
                     header_row=True, scrollX=True, scrollY=True, freeze_rows=1, height=-1, width=-1,
            ...
            for col in result.column_names:
                ...
                add_table_column(
                    label=header_label, 
                    parent=table_tag, 
                    init_width_or_weight=300,  # Increased initial width for better readability
