...
class CredentialsManager:
    ...
    def load_credentials(self, name: str) -> Tuple[bool, Optional[Dict[str, str]], str]:
        ...
        try:
            ...
            # Decrypt password
            credentials = {
                "host": encrypted_credentials.get("host", "localhost"),
                "port": encrypted_credentials.get("port", "9000"),
                "user": encrypted_credentials.get("user", "default"),
                "database": encrypted_credentials.get("database", "default"),
    ...
    def load_credentials_legacy(self) -> Tuple[bool, Optional[Dict[str, str]], str]:
        """
        Load first available credentials (for backward compatibility).
        ...
        # Load the first available credential set
        return self.load_credentials(names[0])
